...
public class EvolutionManager : MonoBehaviour {
    ...
    private List<EANN_Agent> agents = new List<EANN_Agent>();
    ...
    private void StartEvaluation(IEnumerable<Genotype> currentPopulation) {
        ...
        foreach (Genotype genotype in currentPopulation)
            agents.Add(new EANN_Agent(genotype, MathHelper.SoftSignFunction, FNNTopology));
    ...
    private void OnAgentDied(EANN_Agent agent) {
        AgentsAliveCount--;
